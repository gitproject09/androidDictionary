...
public class DictionaryDB {
    ...
    public void addWord(String englishWord, String banglaWord) {
        ...
        String sql = "INSERT INTO " + TABLE_NAME + " (" + ENGLISH + ", " + BANGLA + ", " + USER + ") VALUES ('" + englishWord + "', '" + banglaWord + "', '" + USER_CREATED + "') ";
        db.execSQL(sql);
    }
    ...
    public List<Word> getWords(String englishWord) {
        ...
        String sql = "SELECT * FROM " + TABLE_NAME + " WHERE " + ENGLISH + " LIKE ? ORDER BY " + ENGLISH + " LIMIT 100";
    ...
    public void bookmark(int _id) {
        ...
        String sql = "UPDATE " + TABLE_NAME + " SET " + STATUS + " = '" + BOOKMARKED + "' WHERE " + ID + " = " + _id;
        db.execSQL(sql);
        db.close();
    }
    ...
    public void deleteBookmark(int _id) {
        ...
        String sql = "UPDATE " + TABLE_NAME + " SET " + STATUS + " = '' " + " WHERE " + ID + " = " + _id;
        db.execSQL(sql);
        db.close();
    }
}
